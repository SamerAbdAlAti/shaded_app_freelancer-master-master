...
Widget userCanceledOfferPage() => SingleChildScrollView(
      child: Container(
        child: Column(
          ...
          children: [
            ...
            Center(child: createNewUserCanceledWidget()),
            ...
            createUserLastCanceledOrderWidget(),
            createUserLastCanceledOrderWidget(),
            createUserLastCanceledOrderWidget()
          ],
        ),
...
Widget createNewUserCanceledWidget()=> Card(
  elevation: 0,
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Divider(),
              SizedBox(height: 20.0,),
              Text("ملغية", style: tajawalArabic(size: 20)),
            ],
          ),
        ),
      ],
...
Widget createUserLastCanceledOrderWidget() => Center(
      child: Card(
        elevation: 0,
        shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(14.0),
